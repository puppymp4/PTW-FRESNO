...
If you discover a security vulnerability in the PTW Fresno codebase, we ask that you report it responsibly via email so we can investigate and address it before any public disclosure.

### 📧 Contact

**Email:** [security@riftmedia.io](mailto:security@riftmedia.io)
...
- We treat every report with urgency and confidentiality.

### Scope

This policy applies to:

- The PTW Fresno website and this GitHub repository
- All related infrastructure

---

**Thank you for helping keep PTW Fresno and our customers safe.**

*Maintained by [Rift Media](https://riftmedia.io)*
